...
/// @title ArcadiaVault - central treasury vault using SafeERC20, AccessControl, and Pausable
contract ArcadiaVault is AccessControl, Pausable {
    ...
    function withdraw(IERC20 token, address to, uint256 amount) external onlyRole(TREASURER_ROLE) whenNotPaused {
        require(amount > 0, "amount>0");
